                    ...
                    <div class="row">
                		<div class="col-md-4">
                  		<div class="form-group">
                            <input type="text" class="form-control" name="Name" autocomplete="off" id="Name" placeholder="Nombre Completo">
                  		</div>
                  	</div>

                  	<div class="col-md-4">
                  		<div class="form-group">
                            <input type="text" class="form-control" name="Name" autocomplete="off" id="Name" placeholder="Teléfono">
                  		</div>
                  	</div>
	...
	<div class="container">
		<div class="row-fluid">
	        <div class="col-md-9">
	      	...
	      	<div class="col-md-3">
	    		<h3>COMERCIALIZADORA BURTHON S.A de C.V.</h3>
	    		<address>
