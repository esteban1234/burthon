...
<div class="section text-center quienes">
    <div class="container">
        ...
        <div class="col-md-12">
          ...
          <div class="row">
            <div class="col-md-4 ">
               ...
               <p class="text-center"><i class="fa fa-cubes fa-5x" aria-hidden="true"></i></p>
            </div>
            <div class="col-md-4 ">
                <h4 class="text-center">NUESTRO PROCESO COMPROBADO</h4>
                 <p class="text-center"><br><br><i class="fa fa-check-square-o fa-5x" aria-hidden="true"></i></p>
            </div>
            <div class="col-md-4 ">
                <h4 class="text-center">SU EXPERIENCIA PERSONALIZADA</h4>
                <p class="text-center"><br><br><i class="fa fa-star-o fa-5x" aria-hidden="true"></i> </p>
            </div>
          </div>
        </div>
      </div>
